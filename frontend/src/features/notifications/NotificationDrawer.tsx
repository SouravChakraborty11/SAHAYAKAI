  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col border-l-2 border-gray-200">
          ...
          <div className="p-6 bg-gray-50 border-b-2 border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={onClose}
                className="p-2 text-gray-400 hover:text-gray-700 rounded-lg hover:bg-gray-200 transition-colors"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {loading && notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                ...
                <p className="font-bold text-gray-600">Fetching notifications...</p>
              </div>
            ) : error ? (
              ...
              filteredNotifications.map(item => (
                ...
                >
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="p-2 bg-white rounded-xl shadow-xs border border-gray-100 shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h4 className="font-bold text-gray-900 text-base mt-1 line-clamp-1">
